...
const Sidebar = () => {
    return (
        <div className='w-full text-xs flex items-center justify-around bottom-0 fixed md:pt-10 md:w-28 md:h-full md:justify-normal md:flex-col md:text-base md:bottom-auto lg:w-24 xl:w-28 xl:pl-4'>
