...
interface Props {
    ...
    playlistsItems: PlaylistsItems[] | null,
};

const ChannelSections = ({ playlists, playlistsItems }: Props) => {
    ...
    }, [playlists, playlistsItems, setShowNavbar]);
        ...
        <div>
            {playlists?.items.map((playlist, index) => (
                <div key={`${playlist.id}-${index}`} className='md:w-full lg:w-[95%] pt-4 mx-1 md:mx-0'>
                    <p className='text-xl font-semibold md:ml-36'>
